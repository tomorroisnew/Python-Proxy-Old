...
class TcpProxy:
    ...
    def receive_from(self, client_socket, remote_socket):
        while True:
            ...
            modified_data = logPackets(data, False)  # replace this line with your own logic for editing packets
    ...
    def send_to(self, client_socket, remote_socket):
        while True:
            ...
            if not data:
                break
            # Edit the received data here
            modified_data = logPackets(data, True)  # replace this line with your own logic for editing packets
